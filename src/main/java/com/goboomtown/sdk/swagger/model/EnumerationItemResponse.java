...
import com.goboomtown.sdk.swagger.model.EnumerationItem;
import java.util.*;
...
public class EnumerationItemResponse extends BaseResponse {
  ...
  private List<EnumerationItem> results = null;
  ...
  public void setResults(List<EnumerationItem> results) {
  ...
  public String toString()  {
    ...
    sb.append("class EnumerationItemResponse {\n");
