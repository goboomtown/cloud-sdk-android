...
public class MemberUserResponse extends BaseResponse {
  ...
  private List<MemberUser> results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<MemberUser> getResults() {
    return results;
  }
  public void setResults(List<MemberUser> results) {
  ...
  public String toString()  {
    ...
    sb.append("class MemberUserResponse {\n");
